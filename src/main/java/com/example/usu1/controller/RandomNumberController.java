...
import com.example.usu1.dto.RandomNumberDto;
...
public class RandomNumberController {
    ...
    @GetMapping("random")
    public RandomNumberDto getRandomNumber(HttpServletRequest request, @RequestParam(defaultValue = "0", required = false) int min, @RequestParam(defaultValue = "10", required = false) int max) {
        ...
        randomNumberDto.setRandomValue(returnValue);
